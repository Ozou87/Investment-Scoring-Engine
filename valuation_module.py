...
def ev_ebitda_score(stock_ev_ebitda_multiple:float, sector_median_ev_ebitda_multiple:float) -> int:
    return score_relative_to_sector(stock_ev_ebitda_multiple, sector_median_ev_ebitda_multiple, EV_EBITDA_THRESHOLDS, EV_EBITDA_DEFAULT)
